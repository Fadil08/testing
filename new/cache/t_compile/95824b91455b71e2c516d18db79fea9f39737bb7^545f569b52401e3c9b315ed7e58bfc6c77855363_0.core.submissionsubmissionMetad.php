...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_670d63c0b3c293_60314710',
...
function content_670d63c0b3c293_60314710 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php if ($_smarty_tpl->tpl_vars['coverageEnabled']->value || $_smarty_tpl->tpl_vars['typeEnabled']->value || $_smarty_tpl->tpl_vars['sourceEnabled']->value || $_smarty_tpl->tpl_vars['rightsEnabled']->value) {?>
	<?php $_block_plugin19 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0][0] : null;
if (!is_callable(array($_block_plugin19, 'smartyFBVFormArea'))) {
...
$_block_repeat=true;
echo $_block_plugin19->smartyFBVFormArea(array('id'=>"additionalDublinCore",'title'=>"submission.metadata"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin20->smartyFBVFormSection(array('description'=>"submission.metadataDescription"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			
		<?php $_block_repeat=false;
echo $_block_plugin20->smartyFBVFormSection(array('description'=>"submission.metadataDescription"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
	<?php $_block_repeat=false;
echo $_block_plugin19->smartyFBVFormArea(array('id'=>"additionalDublinCore",'title'=>"submission.metadata"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}?>
...
$_block_repeat=true;
echo $_block_plugin26->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"common.subjects",'required'=>$_smarty_tpl->tpl_vars['subjectsRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin26->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"common.subjects",'required'=>$_smarty_tpl->tpl_vars['subjectsRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin27->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"search.discipline",'required'=>$_smarty_tpl->tpl_vars['disciplinesRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin27->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"search.discipline",'required'=>$_smarty_tpl->tpl_vars['disciplinesRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin28->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"common.keywords",'required'=>$_smarty_tpl->tpl_vars['keywordsRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin28->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"common.keywords",'required'=>$_smarty_tpl->tpl_vars['keywordsRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin29->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"submission.supportingAgencies",'required'=>$_smarty_tpl->tpl_vars['agenciesRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin29->smartyFBVFormSection(array('description'=>"submission.submit.metadataForm.tip",'label'=>"submission.supportingAgencies",'required'=>$_smarty_tpl->tpl_vars['agenciesRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['citationsEnabled']->value) {?>
			<?php $_block_plugin30 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0][0] : null;
if (!is_callable(array($_block_plugin30, 'smartyFBVFormSection'))) {
throw new SmartyException('block tag \'fbvFormSection\' not callable or registered');
}
...
$_block_repeat=true;
echo $_block_plugin30->smartyFBVFormSection(array('label'=>"submission.citations",'required'=>$_smarty_tpl->tpl_vars['citationsRequired']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin30->smartyFBVFormSection(array('label'=>"submission.citations",'required'=>$_smarty_tpl->tpl_vars['citationsRequired']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
	<?php $_block_repeat=false;
