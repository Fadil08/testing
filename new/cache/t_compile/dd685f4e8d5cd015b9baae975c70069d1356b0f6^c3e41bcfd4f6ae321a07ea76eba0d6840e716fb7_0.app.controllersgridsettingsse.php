<?php
/* Smarty version 3.1.36, created on 2024-10-15 02:19:12
  from 'app:controllersgridsettingsse' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_670d60a0310f51_61605298',
...
function content_670d60a0310f51_61605298 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
while ($_block_repeat) {
ob_start();?>
			<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"checkbox",'id'=>"isInactive",'checked'=>$_smarty_tpl->tpl_vars['isInactive']->value,'label'=>"manager.sections.form.deactivateSection"),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormSection', array('list'=>true,'title'=>"user.role.subEditors"));
$_block_repeat=true;
echo $_block_plugin10->smartyFBVFormSection(array('list'=>true,'title'=>"user.role.subEditors"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		<?php if (count($_smarty_tpl->tpl_vars['subeditors']->value)) {?>
			<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['subeditors']->value, 'subeditor', false, 'id');
$_smarty_tpl->tpl_vars['subeditor']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['id']->value => $_smarty_tpl->tpl_vars['subeditor']->value) {
$_smarty_tpl->tpl_vars['subeditor']->do_else = false;
?>
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"checkbox",'id'=>"subEditors[]",'value'=>$_smarty_tpl->tpl_vars['id']->value,'checked'=>in_array($_smarty_tpl->tpl_vars['id']->value,$_smarty_tpl->tpl_vars['assignedSubeditors']->value),'label'=>$_smarty_tpl->tpl_vars['subeditor']->value,'translate'=>false),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<?php }?>
	<?php $_block_repeat=false;
echo $_block_plugin10->smartyFBVFormSection(array('list'=>true,'title'=>"user.role.subEditors"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
