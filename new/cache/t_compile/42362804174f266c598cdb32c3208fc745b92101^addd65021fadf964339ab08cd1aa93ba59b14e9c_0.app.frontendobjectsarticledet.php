...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_670c18504eee99_78694760',
...
function content_670c18504eee99_78694760 (Smarty_Internal_Template $_smarty_tpl) {
...
<article class="obj_article_details">
		...
		<?php if ($_smarty_tpl->tpl_vars['publication']->value->getData('status') !== @constant('STATUS_PUBLISHED')) {?>
...
?>
										<li><a href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>@constant('ROUTE_PAGE'),'page'=>"catalog",'op'=>"category",'path'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['category']->value->getPath() ))),$_smarty_tpl ) );?>
