...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_670c158fa2b710_21111806',
...
function content_670c158fa2b710_21111806 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_130937663670c158f9f3ae4_37716364', "page");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, "layouts/backend.tpl");
}
/* {block "page"} */
class Block_130937663670c158f9f3ae4_37716364 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'page' => 
  array (
    0 => 'Block_130937663670c158f9f3ae4_37716364',
  ),
);
...
">
					<pkp-form
						v-bind="components.<?php echo @constant('FORM_APPEARANCE_SETUP');?>
"
						@set="set"
					/>
				</tab>
...
">
					<pkp-form
						v-bind="components.<?php echo @constant('FORM_APPEARANCE_ADVANCED');?>
"
						@set="set"
					/>
				</tab>
...
">
					<pkp-form
						v-bind="components.<?php echo @constant('FORM_INFORMATION');?>
"
						@set="set"
					/>
				</tab>
...
">
					<pkp-form
						v-bind="components.<?php echo @constant('FORM_ANNOUNCEMENT_SETTINGS');?>
"
						@set="set"
					/>
				</tab>
...
">
					<pkp-form
						v-bind="components.<?php echo @constant('FORM_LISTS');?>
"
						@set="set"
					/>
				</tab>
...
">
					<pkp-form
						v-bind="components.<?php echo @constant('FORM_PRIVACY');?>
"
						@set="set"
					/>
				</tab>
...
">
					<date-time-form
							v-bind="components.<?php echo @constant('FORM_DATE_TIME');?>
"
							@set="set"
					/>
				</tab>
